  ...
  (function(f2) {
    ...
    return function() {
      ...
      (function(process, global2) {
        ...
        inherits2(MqttClient, events.EventEmitter);
        ...
        function bindEventHandler() {
          ...
          my2.onSocketMessage(function(res) {
            if (typeof res.data === "string") {
              ...
              var buffer2 = Buffer2.from(array);
              proxy.push(buffer2);
            } else {
      ...
      define = function(name, desc, options) {
        ...
        dgs.get = function() {
          if (!options.overwriteDefinition && hasOwnProperty2.call(this, name))
            return value;
          desc.value = bind2.call(value, options.resolveContext ? options.resolveContext(this) : this);
      ...
      var callable = require2("./valid-callable"), value = require2("./valid-value"), bind2 = Function.prototype.bind, call = Function.prototype.call, keys = Object.keys, objPropertyIsEnumerable = Object.prototype.propertyIsEnumerable;
      module3.exports = function(method, defVal) {
        return function(obj, cb) {
          ...
          list = keys(obj);
          if (compareFn) {
            list.sort(typeof compareFn === "function" ? bind2.call(compareFn, obj) : void 0);
          }
      ...
      module3.exports = function() {
        ...
        return function(prototype2, props) {
          return create(prototype2 === null ? nullObject : prototype2, props);
        };
      }();
      ...
      var callable = require2("./valid-callable"), forEach2 = require2("./for-each"), call = Function.prototype.call;
      ...
      var create = Object.create, getPrototypeOf2 = Object.getPrototypeOf, plainObject = {};
      module3.exports = function() {
        var setPrototypeOf = Object.setPrototypeOf, customCreate = arguments[0] || create;
        if (typeof setPrototypeOf !== "function")
          return false;
        return getPrototypeOf2(setPrototypeOf(customCreate(null), plainObject)) === plainObject;
      };
      ...
      validate = function(obj, prototype2) {
        value(obj);
        if (prototype2 === null || isObject2(prototype2))
          return obj;
        ...
        if (status.level === 2) {
          if (status.set) {
            ...
            fn = function(obj, prototype2) {
              set2.call(validate(obj, prototype2), prototype2);
              return obj;
            };
          } else {
            fn = function(obj, prototype2) {
          ...
          fn = function self2(obj, prototype2) {
            var isNullBase;
      ...
      base = defineProperties({}, descriptors2);
      module3.exports = exports3 = function(o2) {
        return o2 == null ? create(base) : defineProperties(Object(o2), descriptors2);
      };
      ...
      function generateBuffer(i) {
        var buffer2 = Buffer2.allocUnsafe(2);
      ...
      function generate4ByteBuffer(num) {
        var buffer2 = Buffer2.allocUnsafe(4);
      ...
      module3.exports = function isBuffer2(arg) {
